...
@protocol FBLoginDialogDelegateMSG;
...
@interface FBLoginDialogMSG : FBDialogMSG {
  id<FBLoginDialogDelegateMSG> _loginDelegate;
}

-(id) initWithURL:(NSString *) loginURL
      loginParams:(NSMutableDictionary *) params
      delegate:(id <FBLoginDialogDelegateMSG>) delegate;
@end

///////////////////////////////////////////////////////////////////////////////////////////////////

@protocol FBLoginDialogDelegateMSG <NSObject>
