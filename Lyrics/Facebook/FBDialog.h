...
@interface FBDialogMSG : UIView <UIWebViewDelegate> {
    
  id<FBDialogDelegateMSG> _delegate;
 ...
 * The delegate.
 */
@property(nonatomic,assign) id<FBDialogDelegateMSG> delegate;
...
- (id)initWithURL: (NSString *) loadingURL
         ...
         delegate: (id <FBDialogDelegateMSG>) delegate;
 ...
 */
@protocol FBDialogDelegateMSG <NSObject>
 ...
 */
- (void)dialogDidNotComplete:(FBDialogMSG *)dialog;
 ...
 */
- (BOOL)dialog:(FBDialogMSG*)dialog shouldOpenURLInExternalBrowser:(NSURL *)url;
